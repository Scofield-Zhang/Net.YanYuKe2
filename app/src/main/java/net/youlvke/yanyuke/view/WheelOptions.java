...
import net.youlvke.yanyuke.adapter.ArrayWheelAdapter;
import net.youlvke.yanyuke.view.listener.OnItemSelectedListener;
...
public class WheelOptions<T> {
    ...
    private boolean linkage = false;//联动
	...
	public void setPicker(ArrayList<T> options1Items,
		...
		// 联动监听器
        wheelListener_option1 = new OnItemSelectedListener() {//OnItemSelectedListener
